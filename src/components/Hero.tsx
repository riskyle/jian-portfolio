...
const Hero = () => {
  ...
  const [user, setUser] = useState({
    name: "Jee Ann Guinsod",
    title: "Aspiring Accounting and Finance Professional",
  });

  const socialLinks = [
    { icon: Linkedin, href: "https://www.linkedin.com/in/jeeannguinsod/", label: "LinkedIn" },
    { icon: Instagram, href: "https://www.instagram.com/jeeann.g/", label: "Instagram" },

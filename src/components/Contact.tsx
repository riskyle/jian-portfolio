  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email",
      info: "jeeannguinsod@gmail.com",
      color: "from-blue-500 to-cyan-500"
    },
    {
      icon: Phone,
      title: "Mobile Number",
      info: "+63 927 836 6066",
      color: "from-green-500 to-emerald-500"
    },
    {
      icon: MapPin,
      title: "Location",
      info: "Sibagat, Agusan del Sur, Philippines",
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                ...
                Whether you're a company looking to hire, or you're a business owner
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input placeholder="e.g Jee Ann" onChange={(e) => setName({ ...name, firstname: e.target.value })} />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Last Name
                    </label>
                    <Input placeholder="e.g Guinsod" onChange={(e) => setName({ ...name, lastname: e.target.value })} />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Input type="email" placeholder="e.g jian@gmail.com" onChange={(e) => setEmailData({ ...emailData, from_email: e.target.value })} />
                </div>
